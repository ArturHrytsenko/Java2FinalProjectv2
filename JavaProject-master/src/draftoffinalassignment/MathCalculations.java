...
public class MathCalculations extends Stage {
    ...
    MathCalculations() {
        ...
        mathTest.add(new Expenses(105.00, "Food", "2019/03/4"));
        mathTest.add(new Expenses(189.03, "Food", "2019/05/12"));
        mathTest.add(new Expenses(124.52, "Food", "2019/07/22"));
        ...
        for (int i = 0; i < expenses.size(); i++) {
            ...
            switch(month){
                case "01":
                    ...
                    averages.remove(0); averages.add(0, temp);
                    break;
                case "02":
                    temp = averages.get(1);
                    temp += expenses.get(i).getExpense();
                    averages.remove(1); averages.add(1, temp);
                    break;
                case "03":
                    temp = averages.get(2);
                    temp += expenses.get(i).getExpense();
                    averages.remove(2); averages.add(2, temp);
                    break;
                case "04":
                    temp = averages.get(3);
                    temp += expenses.get(i).getExpense();
                    averages.remove(3); averages.add(3, temp);
                    break;
                case "05":
                    temp = averages.get(4);
                    temp += expenses.get(i).getExpense();
                    averages.remove(4); averages.add(4, temp);
                    break;
                case "06":
                    temp = averages.get(5);
                    temp += expenses.get(i).getExpense();
                    averages.remove(5); averages.add(5, temp);
                    break;
                case "07":
                    temp = averages.get(6);
                    temp += expenses.get(i).getExpense();
                    averages.remove(6); averages.add(6, temp);
                    break;
                case "08":
                    temp = averages.get(7);
                    temp += expenses.get(i).getExpense();
                    averages.remove(7); averages.add(7, temp);
                    break;
                case "09":
                    temp = averages.get(8);
                    temp += expenses.get(i).getExpense();
                    averages.remove(8); averages.add(8, temp);
                    break;
                case "10":
                    temp = averages.get(9);
                    temp += expenses.get(i).getExpense();
                    averages.remove(9); averages.add(9, temp);
                    break;
                case "11":
                    temp = averages.get(10);
                    temp += expenses.get(i).getExpense();
                    averages.remove(10); averages.add(10, temp);
                    break;
                case "12":
                    temp = averages.get(11);
                    temp += expenses.get(i).getExpense();
                    averages.remove(11); averages.add(11, temp);
                    break;
            }
        }
    }
