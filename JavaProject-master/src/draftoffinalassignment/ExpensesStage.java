        ...
        public void handle(ActionEvent event) {
            ...
            if (!typeOk) {
                ...
                for(int l = 0; l < expenseList.size(); l++){
                    System.out.println(expenseList.get(l).getExpense());
                    System.out.println(expenseList.get(l).getTimeOfPurchase());
                    System.out.println(expenseList.get(l).getExpenseCategory());
                }
            }
        }
    }
